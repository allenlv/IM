...
struct qt_meta_stringdata_qt_client_t {
    QByteArrayData data[6];
    char stringdata[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_qt_client_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_qt_client_t qt_meta_stringdata_qt_client = {
    {
...
QT_MOC_LITERAL(5, 36, 14)
    ...
    "qt_client\0send_msg\0\0conn\0update_msg\0"
    "err_msg_update\0"
};
...
const QMetaObject qt_client::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_qt_client.data,
      qt_meta_data_qt_client,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qt_client.stringdata))
