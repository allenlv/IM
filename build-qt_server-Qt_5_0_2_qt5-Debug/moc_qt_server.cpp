...
struct qt_meta_stringdata_qt_server_t {
    QByteArrayData data[5];
    char stringdata[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_qt_server_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_qt_server_t qt_meta_stringdata_qt_server = {
    {
...
QT_MOC_LITERAL(4, 31, 14)
    ...
    "qt_server\0send_msg\0\0update_msg\0"
    "err_msg_update\0"
};
...
void qt_server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->update_msg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->err_msg_update((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject qt_server::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_qt_server.data,
      qt_meta_data_qt_server,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qt_server.stringdata))
